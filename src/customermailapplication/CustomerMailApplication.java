...
public class CustomerMailApplication {
    ...
    public static void main(String[] args) {
        ...
        switch(type) {
            case 1:
                app.customer = CustomerFactory.createCustomer("Regular");
                break;
            case 2:
                app.customer = CustomerFactory.createCustomer("Mountain");
                break;
            case 3:
                app.customer = CustomerFactory.createCustomer("Delinquent");
                break;
